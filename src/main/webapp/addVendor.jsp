    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card form-card p-4">
                <h3 class="mb-1">Register a New Vendor</h3>
                <p class="text-muted">Fill in the details below to add a vendor to the system.</p>

                <c:if test="${not empty error}">
                    <div class="alert alert-danger">${error}</div>
                </c:if>

                <form method="post" action="${pageContext.request.contextPath}/addVendor">
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="category" class="form-select" required>
                                <option value="Standard">Standard (5% tax)</option>
                                <option value="Premium">Premium (20% surcharge + 5% tax)</option>
                            </select>
                        </div>
                        <div class="col-md-6">
